...
class PentemindCampHomeScreen extends StatefulWidget {
  onClickListener listener;
  String currentBatch;
  String className;
  String userType;

  PentemindCampHomeScreen(
      {super.key,
...
class PentemindHomeScreenState extends State<PentemindCampHomeScreen> {
  ...
  void initState() {
    super.initState();
//     debugPrint('home ==============${widget.currentBatch}');
//     debugPrint('home ==============${widget.className}');
  ...
  generateFilteredMenu() {
    ...
    pentemindMenus.add(PentemindItem(9, LocalConstant.MODULE_CHAT_WITHUS,
        LocalConstant.MODULE_CHAT_WITHUS, 'assets/icons/ic_chat.png'));
  }
                ...
                fit: BoxFit.cover,
                  ...
                  Padding(
                    ...
                    child: MyWidget().richText(
                        'Introduction Videos', LightColors.textHeaderStyle16),
                  ),
