...
class ApprovalView extends StatelessWidget {
  ...
  getChildList(List<ApprovalData> list) {
            ...
            Flexible(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return getChildView(list[index]);
                  },
                ))
          ],
        ),
  ...
  getChildView(ApprovalData model) {
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyWidget().richText(
                              'Subject : ', LightColors.textSmallStyle),
                          MyWidget().richText(model.Subject,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: BlocBuilder<ApprovalBloc, List<ApprovalData>>(
      ...
      floatingActionButton: Column(
        ...
        children: <Widget>[
          FloatingActionButton(
            ...
            onPressed: () {
              context.read<ApprovalBloc>().add(CounterIncrementPressed());
            },
          ),
          ...
          FloatingActionButton(
            ...
            onPressed: () {
              context.read<ApprovalBloc>().add(CounterDecrementPressed());
            },
          ),
          const SizedBox(height: 4),
          FloatingActionButton(
...
/// {@endtemplate}
class ApprovalBloc extends Bloc<CounterEvent, List<ApprovalData>> {
  /// {@macro counter_bloc}
  ApprovalBloc() : super(0) {
