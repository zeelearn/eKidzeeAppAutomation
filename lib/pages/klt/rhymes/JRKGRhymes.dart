...
class JRKGRhymesScreen extends StatefulWidget {
  String className;
  String videoName;
  JRKGRhymesScreen(
...
class _KltHomePageState extends State<JRKGRhymesScreen> {
                  ...
                  if (widget.videoName.isNotEmpty) {
                    ...
                    for (int jIndex = 0;
                      ...
                      if (rhymesData.videoList[jIndex].videoName
                        ...
                        //debugPrint('video found for play JRKG 81');
