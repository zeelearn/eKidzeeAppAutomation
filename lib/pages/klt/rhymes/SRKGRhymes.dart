...
class SRKGRhymesScreen extends StatefulWidget {
  String className;
  String videoName;
  SRKGRhymesScreen(
...
class _KltHomePageState extends State<SRKGRhymesScreen> {
                  ...
                  if (widget.videoName.isNotEmpty) {
                    ...
                    for (int jIndex = 0;
                      ...
                      if (rhymesData.videoList[jIndex].videoName
                        ...
                        //debugPrint('video found for play SRKG 78');
...
class RhymesAdaptar extends StatelessWidget {
  ...
  Future<void> downloadFile(
    ...
    var storageReference =
        'gs://kidzeeandroidapp-91faf.appspot.com//klt_content/Rhymes/Senior KG/${specialiti.videoName}.$extention';
