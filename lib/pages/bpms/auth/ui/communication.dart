...
class BPMSCommunication extends StatefulHookConsumerWidget {
  const BPMSCommunication({super.key});
...
class CommunicationCard extends StatelessWidget {
  ...
  CommunicationCard({super.key, required this.model, required this.context});
        ...
        children: [
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
//                   debugPrint(' tap width ${MediaQuery.of(context).size.width}');
