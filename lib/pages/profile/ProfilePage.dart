...
class MapScreenState extends State<ProfilePage>
  ...
  String userName='';
  String displayName='';
  String userId='',userType='',_currentProgramName='';
  int studentId=0;
  loadData() async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    if(prefs.containsKey(LocalConstant.KEY_USER_AVTAR)) {
      imageAvtar = prefs.getString(LocalConstant.KEY_USER_AVTAR) as String;
    }
    ...
    _currentProgramName =
    prefs.containsKey(LocalConstant.KEY_CURRENT_PROGRAM_NAME)
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: imageAvtar.isNotEmpty ? GestureDetector(
                                      onTap: (){
                                        Utility.viewimage(context,imageAvtar);
                                      },
                                      child: FadeInImage(
                                        width: 200,
                                        height: 200,
                                        placeholder:
                                        AssetImage('assets/icons/ic_student.png'),
                                        image: NetworkImage(imageAvtar),
                                        ...
                                        'assets/icons/ic_student.png',width: 150,
                                        fit: BoxFit.fitWidth),
                                  ),
                                ),
                              ],
